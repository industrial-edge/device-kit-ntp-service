...
* Ensure the bug was not already reported by searching the [open issues](https://github.com/industrial-edge/device-kit-ntp-service/issues).
* Check the [closed issues](https://github.com/industrial-edge/device-kit-ntp-service/issues) for solutions to problems other users had.
